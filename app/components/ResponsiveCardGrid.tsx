...
const ResponsiveCardGrid: React.FC<ResponsiveCardGridProps> = ({
  ...
  return (
    <div className="flex flex-col md:bg-slate-50  md:flex-row md:flex-wrap gap-6 p-4">
      {cards.map((card, index) => (
        <div
          key={card.id}
          className="flex flex-col p-4 bg-white rounded-lg md:rounded-2xl shadow-lg md:shadow-xl overflow-hidden text-black overflow-y-auto"
